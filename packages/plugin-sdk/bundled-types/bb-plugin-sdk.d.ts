...
declare const editMessageRequestSchema: z$1.ZodObject<{
    ...
    operationId: z$1.ZodString;
    expectedRequestSequence: z$1.ZodNumber;
}, z$1.core.$strict>;
...
declare const latestMessageEditResponseSchema: z$1.ZodObject<{
    expectedRequestSequence: z$1.ZodNumber;
    input: z$1.ZodArray<z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
        visibility: z$1.ZodOptional<z$1.ZodEnum<{
            "agent-only": "agent-only";
...
type LatestMessageEditResponse = z$1.infer<typeof latestMessageEditResponseSchema>;
...
type ThreadLatestMessageEditResult = LatestMessageEditResponse;
...
interface ThreadsArea {
    ...
    getLatestMessageEdit(args: ThreadStatusArgs): Promise<ThreadLatestMessageEditResult>;
