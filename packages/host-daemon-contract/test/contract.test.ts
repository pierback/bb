...
const INTENTIONAL_OPTIONAL_HOST_DAEMON_FIELDS: Record<string, string> = {
  ...
  "hostDaemonOnlineRpcCommandSchema.disallowedTools":
    "session handoff restatement may omit provider-specific built-in tool removals when the destination provider does not need them.",
  ...
  "hostDaemonOnlineRpcCommandSchema.options.promptMode":
    "session handoff restatement carries a prompt mode only when the restored turn entered through a provider-declared composer action.",
