...
- **Much of bb is already a plugin.** Automations, Side chat, bb connect, Custom instructions, Inline visualizations, and Secrets ship built-in and enabled. Workflows and Ask User Question ship built-in and off by default. GitHub, Docs, Memory, Session Fabric, and Tasks install from the store.
