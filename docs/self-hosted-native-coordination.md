...
Requests live only for the approval window and are bounded in memory. A server
restart intentionally invalidates pending requests; Desktop starts a new flow.
